            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ route('modifier_user', ['userId' => $administrateur['userId']]) }}"
                            class="btn btn-warning">Modifier mot de passe</a>
                        <br><br>

                        <form method="post"
                            action="{{ route('admin.update', ['administrateur' => $administrateur['userId']]) }}">
                            @csrf
                            <input type="hidden" name="_method" value="put">

                            <input type="hidden" class="form-control" id="userId"
                            name="userId" value="{{ $administrateur['userId'] }}">
                           
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label for="exampleInputEmail1" class="form-label">Nom</label>
                                    <input type="text" class="form-control" required="true" id="nom"
                                        name="firstName" value="{{ $administrateur['firstName'] }}"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" required="true" id="prenom"
                                        name="lastName" value="{{ $administrateur['lastName'] }}"
                                        style="border-radius: 10px;">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" required="true" id="adresse" name="adress"
                                        value="{{ $administrateur['adress'] }}" style="border-radius: 10px;">
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="telephone" required="true"
                                        name="telephone" value="{{ $administrateur['telephone'] }}"
                                        style="border-radius: 10px;">
                                </div>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" required="true" id="matricule"
                                        name="matricule" value="{{ $administrateur['matricule'] }}"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" required="true" id="email" name="email"
                                        value="{{ $administrateur['email'] }}" style="border-radius: 10px;">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" required="true" id="username"
                                        name="username" value="{{ $administrateur['username'] }}"
                                        style="border-radius: 10px;" readonly>
                                </div>
                            ...
                            <div class="row" hidden>
                                ...
                                <div class="mb-3 col-md-6">
                                 ...
                                 <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="roleId" name="roleId" value="8">
