        ...
        <div class="my-3 p-3 mt-5 bg-body rounded shadow-sm">
            ...
            <div class="mt-2">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <a href="{{ route ('arrondissement')}}" type="button" class=" btn btn-primary">Arrondissement activée</a></div>
                                ...
                                @foreach($arrondissements as $arrondissement)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-success" title="Activer" onclick="updateStatus({{ $arrondissement['districtId'] }})">
...
<script>
    function updateStatus(districtId) {
        ...
        $.ajax({
            type: 'PUT',
            url: "{{route('arrondissement.activer')}}",
            data: {
                _token: csrfToken,
            ...
            success: function (response) {
                if(parseInt(response)==200 || parseInt(response)==500){
                        ...
                        parseInt(response)==500?($("#msg200").html(`<div class='alert alert-danger text-center' role='alert'>
                            ...
                            <strong> Arrondissement activée avec succès. </strong>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>`)
