    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Ajouter un super admin</div>


                <div class="panel-body">

                    <div id="msg200"></div>
                    <form method="post" action="{{ route('superAdmin.ajouter')}}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" class="form-control" required="true" id="roleId" name="roleId" value="12">
