        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form  method="post" action="{{ route('collecteur.update', ['collecteur'=>$collecteur['userId']] )}}">
                    ...
                    name="userId" value="{{ $collecteur['userId'] }}">
                   
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <label for="exampleInputEmail1" class="form-label">Nom</label>
                            <input type="text" class="form-control" required="true" id="nom"
                                name="firstName" value="{{ $collecteur['firstName'] }}"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" required="true" id="prenom"
                                name="lastName" value="{{ $collecteur['lastName'] }}"
                                style="border-radius: 10px;">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" required="true" id="adresse" name="adress"
                                value="{{ $collecteur['adress'] }}" style="border-radius: 10px;">
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="telephone" required="true"
                                name="telephone" value="{{ $collecteur['telephone'] }}"
                                style="border-radius: 10px;">
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" required="true" id="matricule"
                                name="matricule" value="{{ $collecteur['matricule'] }}"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" required="true" id="email" name="email"
                                value="{{ $collecteur['email'] }}" style="border-radius: 10px;">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <input type="text" class="form-control" required="true" id="username"
                                name="username" value="{{ $collecteur['username'] }}"
                                style="border-radius: 10px;" readonly>
                        </div>
                    ...
                    <div class="row" hidden>
                        ...
                        <div class="mb-3 col-md-6">
                         ...
                         <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" id="roleId" name="roleId" value="14">
