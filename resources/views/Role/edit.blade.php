            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{-- <form method="post" action="{{ route('quartier.update', ['quartiers'=>$quartiers['neighborhoodId']] )}}"> --}}
                        <form method="post" action="{{ route('role.update', ['roleId' => $roles['roleId']]) }}">
                        ...
                        <div class="row mt-3">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" required style="border-radius: 10px;" id="label" name="label" value="{{$roles['label'] }}">
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class=" col-md-12">
                                ...
                                <input type="text" class="form-control" required="true" id="code" style="border-radius: 10px;" name="code" value="{{$roles['code'] }}">
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <textarea name="description" id="description" class="form-control" cols="47" rows="5" style="border-radius: 10px;">{{$roles['description']}}</textarea>                            
                            </div>
                        </div>
