...
@section("contenu")
    ...
    <div class="container-fluid">
        <div class="my-3 p-3 mt-5 bg-body rounded shadow-sm">
            <h3 class="border-bottom pb-2 mb-5">Liste des communes Désactivés</h3>
        
            <div class="mt-2">
                <div class="d-flex justify-content-between mb-2">
                    <!-- la pagination sans oublier code bootstrap dans provider(AppServiceProvider) -->
            
                    <a href="{{ route ('commune')}}" type="button" class=" btn btn-primary">Liste des communes actives</a></div>
                                ...
                                <table id="example" class="table table-bordered table-striped example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Départemefffffnt</th>
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($communes as $commune)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success" title="Activer" onclick="updateStatus({{ $commune['municipalityId'] }})">
            ...
            success: function (response) {
                if(parseInt(response)==200 || parseInt(response)==500){
                        ...
                        parseInt(response)==500?($("#msg200").html(`<div class='alert alert-danger text-center' role='alert'>
                            ...
                            <strong> Commune activée avec succès. </strong>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>`)
