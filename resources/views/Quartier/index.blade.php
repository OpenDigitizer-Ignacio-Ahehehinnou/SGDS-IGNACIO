        ...
        <div class="my-3 p-3 mt-5 bg-body rounded shadow-sm">
            ...
            <div class="mt-2">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <a href="{{ route ('quartier.create')}}" type="button" class=" btn btn-primary">Ajouter un quartier</a></div>
                    <a href="{{ route ('quartier2')}}" type="button" class=" btn btn-primary">Quartier desactivée</a></div>
                                ...
                                @foreach($quartiers as $quartier)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-success" title="Désactiver" onclick="updateStatus({{ $quartier['neighborhoodId'] }})">
    ...
    <div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="POST" action="{{ route('quartier.supprimer') }}">
                    @csrf
            ...
            success: function (response) {
                if(parseInt(response)==200 || parseInt(response)==500){
                        ...
                        parseInt(response)==500?($("#msg200").html(`<div class='alert alert-danger text-center' role='alert'>
                            ...
                            <strong> Quartier désactivée avec succès. </strong>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>`)
