    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Ajouter un quartier</div>

                <div class="panel-body">
                    <form method="post" action="{{ route('quartier.ajouter')}}">
                        @csrf
                        ...
                        <div class="row mt-3">
                            <div class=" col-md-12">
                                <label for="code" class="form-label">Arrondissement</label>
                                <select name="districtId" id="districtId" class="form-control" style="border-radius: 10px;">
                                    @foreach ($arrondissements as $arrondissement )
                                    <option value="{{$arrondissement['districtId']}}">{{$arrondissement['name']}}</option>
