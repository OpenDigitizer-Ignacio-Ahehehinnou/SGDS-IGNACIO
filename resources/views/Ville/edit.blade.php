        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Edition d'une ville</div>
                        ...
                        <form method="post" action="{{ route('ville.update', ['ville'=>$ville['cityId']] )}}">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <input type="text" class="form-control" required="true" id="nom" name="code"
                                        style="border-radius: 10px;" value="{{$ville['code'] }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    <label for="exampleInputPassword1" class="form-label">Ville</label>
                                    <input type="text" class="form-control" required="true" id="prenom" name="nom"
                                        style="border-radius: 10px;" value="{{$ville['nom'] }}">
                                </div>
