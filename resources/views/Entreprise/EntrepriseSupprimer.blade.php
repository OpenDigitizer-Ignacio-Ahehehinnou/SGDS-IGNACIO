...
@section("contenu")
    ...
    <div class="container-fluid">
        <div class="my-3 p-3 mt-5 bg-body rounded shadow-sm">
            <h3 class="border-bottom pb-2 mb-5">Liste des entreprises supprimés</h3>
        
            <div class="mt-2">
                <div class="d-flex justify-content-between mb-2">
                    <!-- la pagination sans oublier code bootstrap dans provider(AppServiceProvider) -->
            
                    <a href="{{ route ('entreprise')}}" type="button" class=" btn btn-primary">Entreprises Actives</a></div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <div class="btn-group" role="group" aria-label="Basic outlined example"> --}}
                                ...
                                <a href="" type="button" class="btn btn-warning" title="Activer entreprise"><i class="bi bi-pencil-square"></i></a>
