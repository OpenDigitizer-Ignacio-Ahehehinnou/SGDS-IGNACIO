...
class CollecteurController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin')->with("success", "Collecteur mis à jour avec succès");
    ...
    public function edit($id)
    {
        ...
        $collecteurss = $response->json();
        $entreprisess = $response2->json();
        $entreprises = $entreprisess['data']['content'];

        $collecteur=$collecteurss['data'];
        //dd($administrateur);
        //l'id de l'entreprise de l'admin
        $entrepriseId=$collecteur['entrepriseId'];
        ...
        return view('collecteur/edit', compact("collecteur","targetEntreprise"));
    }
